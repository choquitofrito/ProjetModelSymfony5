 ...
 */
final class Version20200125230054 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE emprunt ADD exemplaire_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE emprunt DROP exemplaire_id');
    }
}
